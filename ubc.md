...
![Trolls](images/troll-warning.jpg) <!-- .element height="80%" width="80%" -->
...
![Answers](images/answers.jpg) <!-- .element height="90%" width="90%" -->
...
![Networks](images/colorful-network.jpg) <!-- .element height="90%" width="90%" -->
...
![Open Access](images/open-access-logo.png) <!-- .element height="90%" width="90%" -->
...
![Public Engagement](images/nypl.jpg) <!-- .element style="height: 50%; width: 50%" -->
...
![Barriers](images/barriers.jpg) <!-- .element style="height: 90%; width: 90%" -->
...
![Free](images/free.png) <!-- .element style="height: 90%; width: 90%" --> <br /><br /><br />
...
![Labor](images/labor.jpg) <!-- element style="height: 90%; width: 90%" -->
...
![Responsibility](images/better-world.jpg) <!-- element style="height: 90%; width: 90%" -->
...
![Interest](images/reading-writing.jpg) <!-- element style="height: 90%; width: 90%" -->
...
![Public Books](images/public-books.png) <!-- .element height="90%" width="90%" -->
...
![Writing](images/writing.jpg) <!-- element style="height: 90%; width: 90%" -->
...
![Conversation](images/conversation.jpg) <!-- element style="height: 90%; width: 90%" -->
